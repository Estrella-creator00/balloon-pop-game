...
- Stage 21~29는 체력 3인 정상 풍선 2~10개와 Fake Balloon 2개가 함께 등장한다.
- Stage 21~29의 Fake Balloon 수는 스테이지와 무관하게 항상 정확히 2개다.
- Fake Balloon은 장착 중인 `BalloonSkinDefinition`, 공통 렌더러와 팔레트를 그대로 사용하고 최종 출력에서 채도와 밝기만 소폭 낮춘다.
...
| Stage 21~23 | 정상 풍선 2~4개 + Fake 2개 | 정상 각 3 / Fake 1회 제거 | 14초 |
| Stage 24~26 | 정상 풍선 5~7개 + Fake 2개 | 정상 각 3 / Fake 1회 제거 | 19초 |
| Stage 27~29 | 정상 풍선 8~10개 + Fake 2개 | 정상 각 3 / Fake 1회 제거 | 24초 |
